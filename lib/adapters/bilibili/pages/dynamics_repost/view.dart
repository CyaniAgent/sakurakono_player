...
class _RepostPanelState extends CommonRichTextPubPageState<RepostPanel> {
  ...
  List<Map<String, dynamic>>? getRepostContent(CoreDynamicItemModel item) {
    try {
      final modules = item.modules!;
      return [
        {"raw_text": "//", "type": 1, "biz_id": ""},
        {
          "raw_text": "@${modules.moduleAuthor!.name}",
          "type": 2,
          "biz_id": modules.moduleAuthor!.mid.toString(),
        },
        {"raw_text": ":", "type": 1, "biz_id": ""},
        ...modules.moduleDynamic!.desc!.richTextNodes!.map(
          (e) {
            int type;
            String bizId;
            switch (e.type) {

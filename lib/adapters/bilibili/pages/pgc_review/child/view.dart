...
class _PgcReviewChildPageState extends State<PgcReviewChildPage>
  ...
  late final isLongReview = widget.type == CorePgcReviewType.long;
  ...
  Widget _buildBody(
    ThemeData theme,
    LoadingState<List<CorePgcReviewItemModel>?> loadingState,
  ) {
  ...
  Widget _itemWidget(ThemeData theme, int index, CorePgcReviewItemModel item) {

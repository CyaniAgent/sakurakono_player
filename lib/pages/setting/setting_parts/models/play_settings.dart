...
import 'package:skf/pages/video/video_models.dart' show SubtitlePrefType;
...
List<SettingsModel> get playSettings => [
  ...
  NormalModel(
    ...
    getSubtitle: () => '当前全屏方向：${FullScreenMode.values[Pref.fullScreenMode ?? 0].desc}',
  ...
  PopupModel(
    ...
    value: () => PlayRepeat.values[Pref.playRepeat],
...
Future<void> _showFullScreenModeDialog(
  ...
  final res = await showDialog<FullScreenMode>(
    ...
    builder: (context) => SelectDialog<FullScreenMode>(
      title: '默认全屏方向',
      value: FullScreenMode.values[Pref.fullScreenMode ?? 0],

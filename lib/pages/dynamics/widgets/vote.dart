...
class VotePanel extends StatefulWidget {
  final CoreVoteInfo voteInfo;
  final FutureOr<LoadingState<CoreVoteInfo>> Function(Set<int>, bool) onVote;
...
class _VotePanelState extends State<VotePanel> {
      ...
      HeroDialogRoute(
        pageBuilder: (_, _, _) => GalleryViewer(
          sources: _voteInfo.options
              .map((e) => CoreSourceModel(url: e.imgUrl!))
              .toList(),
          initIndex: index,
  ...
  static List<double> _cnt2Percentage(List<CoreOption> options) {

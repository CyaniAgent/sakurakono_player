...
import 'package:skf/adapters/bilibili/pages/video_parts/note/controller.dart';
...
class _NoteListPageState extends State<NoteListPage>
  ...
  Widget _buildBody(
    ThemeData theme,
    LoadingState<List<Map<String, dynamic>>?> loadingState,
  ) {
  ...
  Widget _itemWidget(ThemeData theme, Map<String, dynamic> item) {
    return Material(

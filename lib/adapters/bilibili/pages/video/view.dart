...
import 'package:skf/adapters/bilibili/pages/danmaku/view.dart';
...
import 'package:skf/adapters/bilibili/pages/video/introduction/local/controller.dart';
import 'package:skf/adapters/bilibili/pages/video/introduction/local/view.dart';
import 'package:skf/adapters/bilibili/pages/video/introduction/pgc/controller.dart';
import 'package:skf/adapters/bilibili/pages/video/introduction/pgc/view.dart';
import 'package:skf/adapters/bilibili/pages/video/introduction/pgc/widgets/intro_detail.dart';
import 'package:skf/adapters/bilibili/pages/video/introduction/ugc/controller.dart';
import 'package:skf/adapters/bilibili/pages/video/introduction/ugc/view.dart';
...
import 'package:skf/adapters/bilibili/pages/video/member/view.dart';
import 'package:skf/adapters/bilibili/pages/video/related/view.dart';
import 'package:skf/adapters/bilibili/pages/video/reply/controller.dart';
import 'package:skf/adapters/bilibili/pages/video/reply/view.dart';
import 'package:skf/adapters/bilibili/pages/video/view_point/view.dart';
...
class _VideoDetailPageVState extends State<VideoDetailPageV>
    ...
    if (videoDetailController.showReply) {
      _videoReplyController = Get.put(
        VideoReplyController(
          ...
          videoType: toCoreVideoType(videoDetailController.videoType),
          heroTag: heroTag,
        ),
        tag: heroTag,
      );
  ...
  void showAiBottomSheet() {
    videoDetailController.childKey.currentState?.showBottomSheet(
      ...
      (context) =>
          AiConclusionPanel(item: AiConclusionResult.fromJson(ugcIntroController.aiConclusionResult!)),
    );
  }

...
import 'package:skf/common/widgets/flutter/chat_list_view.dart';
...
import 'package:skf/adapters/bilibili/pages/whisper_detail/controller.dart';
import 'package:skf/adapters/bilibili/pages/whisper_detail/widget/chat_item.dart';
import 'package:skf/adapters/bilibili/pages/whisper_link_setting/view.dart';
          ...
          PopupMenuItem(
            ...
            onTap: () => autoWrapReportDialog(
              ...
              (reasonType, reasonDesc, banUid) async {
                final r = await _whisperDetailController.onReport(
                  item,
                  reasonType,
                  reasonType == 0
                      ? reasonDesc!

          ...
          child: SelectionText.rich(
            ...
            contextMenuBuilder: (_, state) {
              ...
              if (emotes.isNotEmpty) {
                ...
                if (showEmote) {
                  state.addLaunchMenuIfNeeded(buttonItems, index: 4, selectedContent: lastSelection);
                }
              }
              if (state.selectionEndpoints.first !=
                ...
                buttonItems.add(
                  ContextMenuButtonItem(
                    onPressed: () {
                      final selectedText = lastSelection?.plainText;
            ...
            onSelectionChanged: (content) => lastSelection = content,

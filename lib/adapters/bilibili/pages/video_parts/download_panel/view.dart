...
class _DownloadPanelState extends State<DownloadPanel> {
  final DownloadService _downloadService = appRead(downloadServiceProvider);
                            ...
                            if (isCharging == true)
                              ...
                              PBadge(
                                ...
                                type: switch (episode.badge) {
                                  '预告' => CorePBadgeType.gray,
                                  '限免' => CorePBadgeType.free,
                                  _ => CorePBadgeType.primary,
                                },
                              ),
                          ],
                        )
                                ...
                                Row(
                                  ...
                                  children: [
                                    if (view != null)
                                      StatWidget(
                                        value: view,
                                        type: CoreStatType.play,
                                      ),
                                    if (danmaku != null)
                                      StatWidget(
                                        value: danmaku,
                                        type: CoreStatType.danmaku,
                                      ),
                                  ],
                                ),
                              ],

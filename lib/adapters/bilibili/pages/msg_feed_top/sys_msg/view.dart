import 'package:skf/common/skeleton/msg_feed_sys_msg_.dart';
...
import 'package:skf/adapters/bilibili/pages/msg_feed_top/sys_msg/controller.dart';
...
class _SysMsgPageState extends State<SysMsgPage> {
  ...
  Widget _buildBody(
    ThemeData theme,
    LoadingState<List<CoreMsgSysItem>?> loadingState,
  ) {

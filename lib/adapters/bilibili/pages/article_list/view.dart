...
import 'package:skf/adapters/bilibili/pages/article_list/controller.dart';
import 'package:skf/adapters/bilibili/pages/article_list/widgets/item.dart';
...
class _ArticleListPageState extends State<ArticleListPage> with GridMixin {
  ...
  Widget _buildBody(
    ThemeData theme,
    LoadingState<List<CoreArticleListItemModel>?> loadingState,
  ) {
  ...
  Widget _buildHeader(ThemeData theme, CoreArticleListInfo? item) {
    if (item == null) {

...
class _LivePageState extends State<LivePage>
  ...
  Widget _buildTop(ThemeData theme, Pair<CoreLiveCardList?, CoreLiveCardList?> data) {
  ...
  List<Widget> _buildFollowList(ThemeData theme, CoreLiveCardList item) {
  ...
  Widget _buildFollowBody(
    ThemeData theme,
    List<CoreCardLiveItem> followList,
    int totalCount,
  ) {

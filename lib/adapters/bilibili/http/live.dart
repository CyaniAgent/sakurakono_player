...
import 'package:skf/adapters/bilibili/models_new/live/live_danmaku/danmaku_msg.dart';
import 'package:skf/adapters/bilibili/models_new/live/live_dm_block/data.dart';
...
import 'package:skf/adapters/bilibili/models_new/live/live_emote/data.dart';
...
abstract final class LiveHttp {
  ...
  static Future<LoadingState<LiveIndexData>> liveFeedIndex({
    ...
    final params = {
      ...
      's_locale': 'zh_CN',
      'scale': 2,
      'statistics': BiliConstants.statisticsApp,
    };
    ...
    final res = await Request().get(
      ...
      options: Options(
        headers: {
          ...
          'env': 'prod',
          'app-key': 'android',
          'User-Agent': BiliConstants.userAgentApp,
          'x-bili-trace-id': BiliConstants.traceId,
          'x-bili-aurora-eid': '',
          'x-bili-aurora-zone': '',

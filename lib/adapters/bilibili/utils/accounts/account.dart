...
import 'package:skf/adapters/bilibili/utils/accounts/grpc_headers.dart';
...
class AnonymousAccount extends Account {
  ...
  final String csrf = '';
  @override
  final Map<String, String> headers = BiliConstants.baseHeaders;

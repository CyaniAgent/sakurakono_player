...
VideoDetail _$VideoDetailFromJson(Map<String, dynamic> json) => VideoDetail(
  ...
  likeCount: int.tryParse(json['like_count']?.toString() ?? '') ?? ((json['like_count'] as num?)?.toInt() ?? 0),
  favoriteCount: int.tryParse(json['favorite_count']?.toString() ?? '') ?? ((json['favorite_count'] as num?)?.toInt() ?? 0),
  viewCount: int.tryParse(json['view_count']?.toString() ?? '') ?? ((json['view_count'] as num?)?.toInt() ?? 0),
  ...
  ifLike: int.tryParse(json['if_like']?.toString() ?? '') ?? ((json['if_like'] as num?)?.toInt() ?? 0),
  ifFavorite: int.tryParse(json['if_favorite']?.toString() ?? '') ?? ((json['if_favorite'] as num?)?.toInt() ?? 0),

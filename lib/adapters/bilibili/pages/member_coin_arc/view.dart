...
import 'package:skf/adapters/bilibili/pages/member_coin_arc/controller.dart';
import 'package:skf/adapters/bilibili/pages/member_coin_arc/widgets/item.dart';
...
class _MemberCoinArcPageState extends State<MemberCoinArcPage> {
  ...
  void initState() {
    super.initState();
    _ctr = MemberCoinArcController(mid: widget.mid);
  }

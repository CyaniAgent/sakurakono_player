import 'package:skf/common/skeleton/fav_pgc_item.dart';
...
class _FavPgcChildPageState extends State<FavPgcChildPage>
  ...
  void initState() {
    ...
    favPgcControllerRegistry['${widget.type}${widget.followStatus}'] =
        _favPgcController;
    _favPgcController.attachRef(ProviderScope.containerOf(context));
  }
  ...
  Widget _buildBody(LoadingState<List<CoreFavPgcItemModel>?> loadingState) {

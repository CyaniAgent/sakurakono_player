...
import 'package:skf/adapters/bilibili/models_new/video/video_detail/desc_v2.dart';
...
class _UgcIntroPanelState extends State<UgcIntroPanel> {
                ...
                spanChildren.add(
                  TextSpan(
                    ...
                    recognizer: NoDeadlineTapGestureRecognizer()
                      ..onTap = () async {
                        if ((videoDetailCtr.plPlayerController
        ...
        return Row(
          ...
          children: [
            PendantAvatar(
              ...
              size: 35,
              badgeSize: 14,
              vipStatus: userStat.card?.coreVip?.status,
            ...
            Column(
              ...
              children: [
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 13,
                    color: isVip && userStat.card?.coreVip?.type == 2
                        ? colorScheme.vipColor
                        : null,
                  ),
                ),
    ...
    child: Center(
      child: GestureDetector(
        ...
        onTap: () async {
          ...
          final aiResult = introController.aiConclusionResult;
          if (aiResult case final Map<String, dynamic> result) {
            final aiConclusionResult = AiConclusionResult.fromJson(result);
            final summary = aiConclusionResult.summary;
            final outline = aiConclusionResult.outline;
  ...
  Widget _buildTags(List<CoreVideoTagItem> tags) {
    return Padding(

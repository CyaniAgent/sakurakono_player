...
class _MusicDetailPageState extends CommonDynPageState<MusicDetailPage> {
  ...
  Widget _buildArtist(CoreArtist artist, TextStyle? style) {
  ...
  Widget _buildCard(CoreMusicDetail item, double maxWidth) {
                ...
                children: [
                  GestureDetector(
                    onTap: () => PageUtils.imageView(
                      imgList: [CoreSourceModel(url: item.mvCover!)],
                    ),
                    child: fromHero(
                      tag: item.mvCover!,
  ...
  Widget? _buildChart(CoreMusicDetail item, double maxWidth) {
  ...
  void _searchMusic(CoreMusicDetail item) {

...
import 'package:skf/adapters/bilibili/pages/member_comic/controller.dart';
      ...
      child: CustomScrollView(
        ...
        slivers: [
          SliverPadding(
            ...
            sliver: Obx(() => _buildBody(_controller.loadingState.value as LoadingState<List<SpaceArchiveItem>?>)),
          ),
        ],
      ),
    );

...
class _DynTopicPageState extends State<DynTopicPage>
  ...
  Widget _buildBody(LoadingState<List<CoreTopicCardItem>?> loadingState) {
  ...
  Widget _itemBuilder(List<CoreTopicCardItem> list, int index) {
  ...
  Widget _buildFoldItem(CoreFoldCardItem item) {
    return Padding(

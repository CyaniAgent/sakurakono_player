...
class DynamicPanel extends StatelessWidget {
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            if (!isDetail) ...[
              if (item.modules?.moduleInteraction case CoreModuleInteraction(
                :final items,
              ))
  ...
  Widget _buildFoldItem(ThemeData theme, CoreModuleFold moduleFold) {
  ...
  Widget _buildDispute(ThemeData theme, CoreModuleDispute moduleDispute) {

...
import 'package:skf/adapters/bilibili/pages/live_area_detail/child/view.dart';
...
class _LiveAreaDetailPageState extends State<LiveAreaDetailPage> {
  ...
  Widget _buildBody(
    ThemeData theme,
    double bottom,
    LoadingState<List<CoreAreaItem>?> loadingState,
  ) {

...
class _ContributionRankPanelState extends State<ContributionRankPanel>
  ...
  void initState() {
    ...
    _tabController = TabController(
      length: CoreLiveContributionRankType.values.length,
      vsync: this,
    );
  }
      ...
      children: [
        SizedBox(
          ...
          child: TabBar(
            ...
            tabs: CoreLiveContributionRankType.values
        ...
        Expanded(
          child: tabBarView(
            controller: _tabController,
            children: CoreLiveContributionRankType.values
                .map(
...
class _ContributionRankTypeState extends State<_ContributionRankType>
  ...
  Widget _buildBody(
    bool showScore,
    LoadingState<List<CoreLiveContributionRankItem>?> state,
  ) {
    return switch (state) {
...
class _Item extends StatelessWidget {
  ...
  final CoreLiveContributionRankItem item;

...
import 'package:skf/adapters/bilibili/pages/msg_feed_top/like_me/controller.dart';
  ...
  Widget _buildBody(ThemeData theme, LoadingState loadingState) {
    ...
    return switch (loadingState) {
      ...
      Success(:final response) => Builder(
        builder: (context) {
          Pair<List<CoreMsgLikeItem>, List<CoreMsgLikeItem>> pair = response;
          List<CoreMsgLikeItem> latest = pair.first;
          List<CoreMsgLikeItem> total = pair.second;

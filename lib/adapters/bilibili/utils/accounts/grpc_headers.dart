...
import 'package:skf/adapters/bilibili/grpc/bilibili/metadata.pb.dart';
import 'package:skf/adapters/bilibili/grpc/bilibili/metadata/device.pb.dart';
import 'package:skf/adapters/bilibili/grpc/bilibili/metadata/fawkes.pb.dart';
import 'package:skf/adapters/bilibili/grpc/bilibili/metadata/locale.pb.dart';
import 'package:skf/adapters/bilibili/grpc/bilibili/metadata/network.pb.dart' as network;
...
abstract final class GrpcHeaders {
  ...
  static String get _traceId => BiliConstants.traceId;
  ...
  static final Map<String, String> _base = {
    ...
    'user-agent': BiliConstants.userAgent,
    'x-bili-gaia-vtoken': '',
    'x-bili-aurora-zone': '',
